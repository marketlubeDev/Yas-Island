...
function Loader() {
  const { isDarkMode } = useSelector((state) => state.accessibility);
  ...
  <style>
      :root {
          ...
          --dot-size: 12px;
          --dot-color: ${isDarkMode ? "#555E64" : "#AEB9BE"};
          --arc-color: #FFEA00;
          --loader-width: 14px;
          --duration: 1.8s;
          --continuous-gravity: cubic-bezier(0.68, 0.2, 0.32, 0.8);
          --dots-duration: 7s;
          --loader-background-color: ${isDarkMode ? "#101010" : "#FEFEFE"};
      }
      ...
      .loader-container {
          ...
          background-color: var(--loader-background-color) !important;
