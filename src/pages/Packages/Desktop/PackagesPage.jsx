...
export default function PackagesPage() {
  ...
  const handleIframeLoad = () => {
    ...
    try {
      ...
      // Remove bottom padding from the last section (social-gallery-section)
      const lastSection = doc.querySelector(".social-gallery-section");
      if (lastSection) {
      ...
      const computeHeight = () => {
        ...
        // Find the last section element (social-gallery-section is typically last)
        const sections = doc.querySelectorAll(
          ".packages-section, .birthday-section, .magazine-section, .single-day-section, .social-gallery-section"
        );
