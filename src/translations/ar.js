export const ar = {
  ...
  noResults: {
    ...
    titleWithFilters: "لم يتم العثور على نتائج",
    subtitle:
      "لا توجد معالم متاحة حالياً. يرجى التحقق لاحقاً أو التواصل مع فريق الدعم.",
    subtitleWithFilters:
      "لم نتمكن من العثور على أي معالم تطابق معايير البحث الخاصة بك. حاول تعديل المرشحات أو مصطلحات البحث.",
  ...
  payment: {
    ...
    verification: {
      ...
      willExpire: "يمكنك طلب رمز تحقق جديد بعد",
    ...
    success: {
      ...
      redirecting: "سيتم تحويلك إلى الصفحة الرئيسية في",
      seconds: "ثوانٍ",
    },
    response: {
      ...
      redirecting: "سيتم تحويلك إلى الصفحة الرئيسية في 3 ثوانٍ",
      seconds: "ثوانٍ",
    },
    promo: {
  ...
  toastMessages: {
    ...
    invalidCountry: "يرجى تحديد البلد",
    somethingWentWrong: "هناك خطأ ما",
    otpExpired: "رمز التحقق لقد انتهى. يرجى طلب واحد جديد.",
    invalidOTP: "يرجى إدخال رمز تحقق صالح",
    otpIncorrect: "رمز التحقق غير صالح ❌",
    invalidPromoCode: "يرجى إدخال رمز خصم صالح",
    failedToLoadTermsAndConditions: "فشل تحميل الشروط والأحكام",
    acceptTermsAndConditions: "يرجى قبول الشروط والأحكام للمتابعة",
    thisProductIsCurrentlyNotAvailable: "هذا المنتج غير متاح حالياً",
  ...
  pageTitle: {
    title:
      "جزيرة ياس | جزيرة ياس، واحدة من أكثر الوجهات السياحية شعبية في العالم، تقدم مركز ترفيهي عائلي لا مثيل له. احجز إجازتك اليوم.",
    home: "جزيرة ياس | احجز مغامرتك اليوم",
    emailVerification: "جزيرة ياس | التحقق من البريد الإلكتروني",
    otpConfirmation: "جزيرة ياس | تأكيد رمز التحقق",
    paymentDetails: "جزيرة ياس | تفاصيل الضيف والدفع",
    cardPayment: "جزيرة ياس | الدفع بالبطاقة",
    paymentSuccess: "جزيرة ياس | تم الدفع بنجاح",
    paymentResponse: "جزيرة ياس | رد الدفع",
    upcoming: "جزيرة ياس | قريباً",
